...
async def maybe_compact(
    ...
    # Auto-compaction is background work — force free/local (free_only=True).
    util_url, util_model, util_headers = resolve_endpoint("utility", owner=owner, free_only=True)

...
HOUSEKEEPING_DEFAULTS = {
    ...
    # Active by default (unlike the paused LLM/email tasks): a cheap, read-only
    # CalDAV pull, and a no-op (TaskNoop) when CalDAV isn't configured.
    "sync_calendar":        {"name": "Calendar Sync",            "schedule": "cron",  "scheduled_time": None,    "cron_expression": "0 */3 * * *", "legacy_names": []},
    ...
    "daily_brief":           {"name": "Daily Brief",              "schedule": "cron",  "scheduled_time": None,    "cron_expression": "0 7 * * *", "ship_paused": True, "legacy_names": []},
